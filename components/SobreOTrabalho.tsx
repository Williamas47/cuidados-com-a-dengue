      ...
      <div className="max-w-5xl mx-auto px-4">
        ...
        <div className="bg-[#f0f4ff] rounded-3xl p-8 mb-12 border-l-4 border-[#4ECDC4] shadow-sm">
          <p className="text-gray-700 text-lg leading-relaxed">
            ...
            informações de forma dinâmica e acessível ao público
            infantojuvenil, tornando o aprendizado sobre prevenção mais
            educativo, interativo e de fácil compreensão.
          </p>
        </div>
